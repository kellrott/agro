...
type Job struct {
	...
	Stdout           *string        `protobuf:"bytes,7,opt,name=stdout" json:"stdout,omitempty"`
	Stderr           *string        `protobuf:"bytes,8,opt,name=stderr" json:"stderr,omitempty"`
	Worker           *string        `protobuf:"bytes,9,opt,name=worker" json:"worker,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
